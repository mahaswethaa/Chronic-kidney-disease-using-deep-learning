...
def pre(age, BloodPressure, SpecificGravity, Albumin, Sugar, RBC, Pus_Cell, Pus_Cell_Clump, Bacteria, Blood_Glucose_Random
    ...
    t = [age, BloodPressure, SpecificGravity, Albumin, Sugar, RBC, Pus_Cell, Pus_Cell_Clump, Bacteria, Blood_Glucose_Random
    , Blood_Urea, Serum_Creatinine, Sodium, Potassium, Hemoglobin, Packed_Cell_Volume, WBC_Count, RBC_Count, HyperTension
    , Diabetes_Mellitus, Cor_Art_Dis, Appetite, Pedal_Edema, Anemia]
...
#    svm_val = svm.predict_proba(scaled_X)
    ...
    output = (lr_val+rf_val+knn_val+sgd_val)/5
    output = output[0]
